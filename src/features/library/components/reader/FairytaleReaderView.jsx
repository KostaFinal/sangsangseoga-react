...
export default function FairytaleReaderView({ book,  initialPageKey = 0, onComplete, onLastPageBlocked, onPageChange, viewType = "FLIP", fontSize = "base", isEnglish = false }) {
