  ...
  return (
    <div id="profile-edit-container" className="bg-[#FAF9FF] min-h-screen font-sans text-[#2F2D59] w-full leading-relaxed">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-5 sm:px-6 md:px-8">
        ...
        {/* Tab Navigation Segmented Menu — 전환할 탭이 실제로 있을 때만 노출 */}
        {showGuardianTab && (
          <div className="flex border-b border-[#E6E2FC]/60 bg-white/70 backdrop-blur-md p-1 rounded-2xl mb-5 gap-2 w-full sm:w-fit shadow-xs">
            <button
              type="button"
        ...
        {activeTab === 'guardian' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
            ...
            <div className="lg:col-span-8 bg-white rounded-3xl p-5 sm:p-6 border border-[#E6E2FC]/50 shadow-[0_8px_30px_rgb(0,0,0,0.02)] space-y-6">
              ...
              <div className="space-y-3 text-left">
                <div className="border-b border-[#E6E2FC]/40 pb-3 flex flex-wrap justify-between items-center gap-3 bg-white">
                  ...
                  <span className="bg-[#FAF9FF] text-[#6B54E7] text-xs font-black px-3 py-1.5 rounded-full border border-[#E6E2FC] shrink-0 font-mono">
            ...
            <div className="lg:col-span-4 space-y-5">
              ...
              <div className="bg-[#110F24] text-white space-y-3 text-left shadow-lg rounded-3xl p-5 sm:p-6 border border-[#2F2D59]/50 relative overflow-hidden">
                ...
                <div className="space-y-3 text-xs font-sans leading-relaxed text-[#B9B0DC] relative z-10">
                  ...
                  <div className="space-y-3 border-t border-[#2F2D59] pt-3 text-left">
