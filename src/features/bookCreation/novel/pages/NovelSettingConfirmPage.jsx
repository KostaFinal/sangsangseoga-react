  ...
  return (
    <div className="novel-confirm-page">
      ...
      <main className="novel-confirm-main">
        ...
        <div className="confirm-step-row">
          <div className="confirm-step-spacer" aria-hidden="true" />
        ...
        <section className="confirm-layout">
          <aside className="confirm-sidebar-panel">
            <h2>✦ 연출 회의 현황 ✦</h2>
            ...
            <div className="novel-chat-window">
              ...
              {!isAllComplete && currentStep && (
                <div className="current-question-box">
                  ...
                  {showFallbackNotice && !isLoadingOptions && (
                    <p className="confirm-fallback-notice">
                      AI 추천을 불러오지 못해 기본 선택지를 보여드리고 있어요.
                    </p>
                  )}

                  <div className={`novel-chat-option-grid ${isLoadingOptions ? "loading" : ""}`}>
                  ...
                  <button
                    ...
                    disabled={isLoadingOptions}
                  >
                    {isLoadingOptions ? "AI가 생각 중..." : "↻ 다시 추천"}
                  </button>
                </div>
              )}
              ...
              {isAllComplete && (
                <div className="current-question-box complete">
                  ...
                  <p>
                    왼쪽 연출 회의 현황을 확인한 뒤 에디터로 이동하면 됩니다.
                  </p>
                </div>
              )}
